      ...
      <div>
        ...
        <Content>
          <Slider {...settings} ref={slider => (this.slider = slider)}>
            {
              current_partner && current_partner.process_set.map((item, idx) => {
                return <Image key={idx} ratio='65%' src={item.img_process}/>
              })
            }
          </Slider>
          {
            (current_partner && current_partner.process_set.length > 0)
              && (
                <>
