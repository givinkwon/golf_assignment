      ...
      <div id="portfolio">
        ...
        <Content>
          <Slider {...settings} ref={slider => (this.slider = slider)}>
            {
              Partner.detail.portfolio_set.length > 0 && Partner.detail.portfolio_set.map((item, idx) => {
                console.log(Partner.detail)
                return (
                  <ImageWrapper>
                    <Image key={idx} src={item.img_portfolio}/>
                  </ImageWrapper>
                )
              })
            }
          ...
          {
            Partner.detail.portfolio_set.length > 3 &&
                <>
